...
(function(){
  var root, postJsonExt, getCookie, setFbnameFburlCookies, getRemoteCookies, addlogfb, addlog;
  ...
  setFbnameFburlCookies = function(){
    var yearlater;
  ...
  chrome.runtime.onMessage.addListener(function(request, sender, sendResponse){
    ...
    if (request != null && request.feedlearn === 'getformat') {
      ...
      if (root.fbname != null && root.fburl != null) {
        setFbnameFburlCookies();
      }
      format = 'interactive';
      sendResponse({
